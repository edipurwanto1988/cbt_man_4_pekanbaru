                        ...
                        <div class="relative">
                            ...
                            <div id="dropdown-menu-{{ $bankSoal->id }}" class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-md shadow-lg z-10">
                                <div class="py-1">
                                    ...
                                    @else
                                        <a href="{{ route('guru.jadwal_ujian.posttest.live', $bankSoal->id) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
