...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('guru.jadwal_ujian.show', $session->id) }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <form action="{{ route('guru.jadwal_ujian.update', $session->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('guru.jadwal_ujian.show', $session->id) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    Batal
                </a>
