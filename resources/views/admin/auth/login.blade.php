...
<head>
    ...
    <title>CBT Admin Portal - Login</title>
    ...
    <div class="layout-container flex h-full grow flex-col">
        <header class="absolute top-0 left-0 right-0 z-10 p-6 sm:p-8">
            <div class="mx-auto flex max-w-7xl items-center justify-between">
                <div class="flex items-center gap-3 text-gray-900 dark:text-white">
                    ...
                    <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]">CBT Admin Portal</h2>
                </div>
            </div>
        </header>
        <main class="flex flex-1 items-center justify-center py-16 px-4">
            <div class="w-full max-w-md space-y-8">
                <div class="text-center">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Admin Login</h1>
                    <p class="mt-2 text-base text-gray-600 dark:text-gray-400">Sign in to manage tests and students.</p>
                </div>
                <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 p-6 sm:p-8 shadow-sm">
                    <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-6">
                        @csrf
                        <div class="space-y-2">
                            <label class="text-sm font-medium leading-none text-gray-700 dark:text-gray-300" for="email">Email</label>
        ...
        <footer class="w-full py-6 px-4 sm:px-8">
            <div class="mx-auto flex max-w-7xl items-center justify-center text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">© {{ date('Y') }} CBT Admin Portal. All rights reserved. | <a class="hover:underline" href="#">Technical Support</a></p>
            </div>
        </footer>
    </div>
</div>
