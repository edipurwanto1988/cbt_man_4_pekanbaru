...
@section('content')
    ...
    <header class="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.bank_soals.edit', $bankSoal->id) }}" class="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-blue-600 text-white text-sm font-bold leading-normal tracking-wide hover:bg-blue-700 transition-colors">
