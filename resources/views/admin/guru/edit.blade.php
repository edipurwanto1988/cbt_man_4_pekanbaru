...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Guru</h1>
            <p class="text-gray-600 dark:text-gray-400">Perbarui data guru</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
        <form action="{{ route('admin.guru.update', $guru->id_guru) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
