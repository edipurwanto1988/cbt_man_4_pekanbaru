...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <form action="{{ route('admin.jadwal_ujian.store') }}" method="POST">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.jadwal_ujian.pretest') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    Batal
                </a>
