...
@section('content')
    ...
    <header class="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.bank_soal.index') }}" class="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-gray-200 text-gray-700 text-sm font-bold leading-normal tracking-wide hover:bg-gray-300 transition-colors">
            ...
            <a href="{{ route('admin.pertanyaan_soal.create', $bankSoal->id) }}" class="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-wide hover:bg-primary/90 transition-colors">
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div id="dropdown-{{ $pertanyaanSoal->id }}"
                                            ...
                                            <div class="py-1">
                                                <a href="{{ route('admin.pertanyaan_soal.show', [$bankSoal->id, $pertanyaanSoal->id]) }}"
                                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    <i class="ri-eye-line mr-2"></i>
                                                    Lihat Detail
                                                </a>
                                                <a href="{{ route('admin.pertanyaan_soal.edit', [$bankSoal->id, $pertanyaanSoal->id]) }}"
                                                   class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('admin.pertanyaan_soal.template', $bankSoal->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    ...
    <script>
        ...
        function deleteSelected() {
            ...
            form.method = 'POST';
            form.action = "{{ route('admin.pertanyaan_soal.destroy_multiple', $bankSoal->id) }}";
        ...
        importBtn.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch("{{ route('admin.pertanyaan_soal.import', $bankSoal->id) }}", {
                    method: 'POST',
                    body: formData,
                    headers: {
